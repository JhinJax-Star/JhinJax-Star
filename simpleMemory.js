! function() {
	var s, e, t, l, r, o, n = {
			434: function(s, e, t) {
				...
				function l(s) {
					let e = {
						init: () => {
							s.__event.scroll = {}, s.__event.scroll.handle = [], s.__event.scroll
								.temScroll = 0, s.__event.scroll.docScroll = $(document).scrollTop(), s
								.__event.scroll.homeScroll = $("#home").offset().top - 40, $(window).scroll(
									(() => {
										s.__event.scroll.docScroll = $(document).scrollTop(), s.__event
											.scroll.homeScroll = $("#home").offset().top - 40, e.handle
											.scroll(), s.__event.scroll.temScroll = s.__event.scroll
											.docScroll
									})), s.__event.resize = {}, s.__event.resize.handle = [], $(window)
								.resize((() => {
									e.handle.resize()
								}))
						},
						handle: {
							scroll: () => {
								for (let e = 0; e < s.__event.scroll.handle.length; e++) s.__event.scroll
									.handle[e]()
							},
							resize: () => {
								for (let e = 0; e < s.__event.resize.handle.length; e++) s.__event.resize
									.handle[e]();
								s.__tools.setDomHomePosition()
							}
						}
					};
					return e
			...
			1793: function(s, e, t) {
				...
				$(document).ready((function() {
					let s = {};
					s.__config = function() {
						const s = void 0 === window.cnblogsConfig ? {} : window.cnblogsConfig;
						return $.extend(!0, l, s)
					}(), s.__status = function() {
						let s = {};
						s.url = window.location.href;
						let e = s.url.split("/");
						if (s.user = e[3], s.articleId = "", s.homeUrl = [e[0], e[1], e[2], e[3]]
							.join("/"), $("#topics").length) {
							$("#bookListFlg").length ? s.pageType = "books" : $("#linkListFlg")
								.length ? s.pageType = "links" : s.pageType = "article";
							let t = e[e.length - 1].split(".");
							s.articleId = t[0]
						} else s.pageType = "home";
						return s
					}(), s.__tools = {
						tempReplacement: (s, e, t) => {
							let l = new RegExp("##" + e + "##", "g");
							return s.replace(l, t)
						},
						batchTempReplacement: (s, e) => {
							let t = s;
						...
						dynamicLoadingCss: s => {
							if (!s || 0 === s.length) throw new Error(
								'argument "path" is required !');
							let e = document.getElementsByTagName("head")[0],
								t = document.createElement("link");
							t.href = s, t.rel = "stylesheet", t.type = "text/css", e
								.appendChild(t)
						},
						htmlFiltrationScript: s => {
							let e = new RegExp("<script.*<\/script>", "ig");
							return s.replace(e, "")
						},
						clearIntervalTimeId: s => {
						...
						getScrollPercent: () => ($(window).scrollTop() / ($(document).height() - $(
							window).height()) * 100).toFixed(0),
						...
						getNowFormatDate: () => {
							let s = new Date,
								...
								t = s.getMonth() + 1,
								l = s.getDate();
							return t >= 1 && t <= 9 && (t = "0" + t), l >= 0 && l <= 9 && (l =
								"0" + l), e + "-" + t + "-" + l
						},
						getRunDate: s => {
							s = s.toString().split("-");
							let e = new Date;
							e.setUTCFullYear(s[0], s[1] - 1, s[2]), e.setUTCHours(0, 0, 0, 0);
							let t = e,
								l = (new Date).getTime() - t.getTime(),
								r = l / 1e3,
								o = (Math.floor(r), l / 864e5),
								n = Math.floor(o),
								a = -24 * (n - o),
								i = Math.floor(a),
								c = -60 * (i - a),
							...
							return {
								...
								hrsold: i,
								minsold: h,
								seconds: Math.floor(-60 * (h - c)).toString()
							}
						},
						setCookie: (s, e, t) => {
							let l = new Date;
							l.setTime(l.getTime() + 1e3 * t), document.cookie = s + "=" +
								escape(e) + "; expires=" + l.toGMTString() + "; path=/"
						},
						getCookie: s => {
							let e, t = new RegExp("(^| )" + s + "=([^;]*)(;|$)");
							return e = document.cookie.match(t), e ? unescape(e[2]) : null
						},
						randomString: s => {
							s = s || 32;
							let e = "ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz2345678",
								t = e.length,
								l = "";
							for (let r = 0; r < s; r++) l += e.charAt(Math.floor(Math.random() *
								t));
							return l
						},
						minToTime: s => {
							let e = parseInt(s),
								t = parseInt(60 * (s - e));
							return t = 1 === ("" + t).length ? "0" + t : t, `${e}:${t}`
						}
					}, s.__timeIds = {}, s.__event = {}, "" === s.__config.info.name && (s.__config
						.info.name = s.__status.user), t(2865)(`./${s.__status.pageType}`).then((
						e => {
							const l = e.default;
							Promise.all([t.e(9509), t.e(3304)]).then(t.bind(t, 9990)).then((
							e => {
								(0, e.default)(s), l(s), t.e(3258).then(t.bind(t,
									7987)).then((e => {
									(0, e.default)(s), s.__tools
										.setDomHomePosition(), (0, r.Z)(
											s).handle.scroll(), (0, r.Z)
										(s).handle.resize()
								}))
							}))
						}))
			...
			2865: function(s, e, t) {
				...
				function r(s) {
					if (!t.o(l, s)) return Promise.resolve().then((function() {
						var e = new Error("Cannot find module '" + s + "'");
						throw e.code = "MODULE_NOT_FOUND", e
					}));
					var e = l[s],
						r = e[0];
					return Promise.all(e.slice(1).map(t.e)).then((function() {
						return t(r)
					}))
				}
				r.keys = function() {
					return Object.keys(l)
				}, r.id = 2865, s.exports = r
			}
		},
		a = {};
	...
	function i(s) {
		...
		return n[s].call(t.exports, t, t.exports, i), t.exports
	}
	i.m = n, i.n = function(s) {
		...
		}, e = Object.getPrototypeOf ? function(s) {
			return Object.getPrototypeOf(s)
		} : function(s) {
			return s.__proto__
		}, i.t = function(t, l) {
			if (1 & l && (t = this(t)), 8 & l) return t;
			if ("object" == typeof t && t) {
				if (4 & l && t.__esModule) return t;
				if (16 & l && "function" == typeof t.then) return t
			}
			...
			s = s || [null, e({}), e([]), e(e)];
			for (var n = 2 & l && t;
				"object" == typeof n && !~s.indexOf(n); n = e(n)) Object.getOwnPropertyNames(n).forEach((function(s) {
				o[s] = function() {
					return t[s]
				}
			}));
			...
			for (var t in e) i.o(e, t) && !i.o(s, t) && Object.defineProperty(s, t, {
				enumerable: !0,
				get: e[t]
			})
		}, i.f = {}, i.e = function(s) {
			return Promise.all(Object.keys(i.f).reduce((function(e, t) {
				return i.f[t](s, e), e
			}), []))
		}, i.u = function(s) {
			return "script/" + ({
			...
			} [s] || s) + "." + i.h().slice(0, 8) + ".js"
		}, i.miniCssF = function(s) {
			return "style/" + {
				131: "hljs/atelier-savanna-light-css",
				269: "page-article",
				336: "hljs/atelier-plateau-dark-css",
		...
		}, t = {}, l = "Cnblogs-Theme-SimpleMemory:", i.l = function(s, e, r, o) {
			if (t[s]) t[s].push(e);
			else {
				var n, a;
				if (void 0 !== r)
					for (var c = document.getElementsByTagName("script"), h = 0; h < c.length; h++) {
						var u = c[h];
						if (u.getAttribute("src") == s || u.getAttribute("data-webpack") == l + r) {
							n = u;
							break
						}
					}
				n || (a = !0, (n = document.createElement("script")).charset = "utf-8", n.timeout = 120, i.nc && n
					.setAttribute("nonce", i.nc), n.setAttribute("data-webpack", l + r), n.src = s), t[s] = [e];
				var d = function(e, l) {
						n.onerror = n.onload = null, clearTimeout(g);
						var r = t[s];
						if (delete t[s], n.parentNode && n.parentNode.removeChild(n), r && r.forEach((function(s) {
								return s(l)
							})), e) return e(l)
					},
				...
				n.onerror = d.bind(null, n.onerror), n.onload = d.bind(null, n.onload), a && document.head.appendChild(
					n)
			}
		}, i.r = function(s) {
		...
		function() {
			var s;
			i.g.importScripts && (s = i.g.location + "");
			var e = i.g.document;
			...
			s = s.replace(/#.*$/, "").replace(/\?.*$/, "").replace(/\/[^\/]+$/, "/"), i.p = s
		}(), r = function(s) {
			return new Promise((function(e, t) {
				var l = i.miniCssF(s),
					r = i.p + l;
				if (function(s, e) {
						for (var t = document.getElementsByTagName("link"), l = 0; l < t.length; l++) {
							var r = (n = t[l]).getAttribute("data-href") || n.getAttribute("href");
							if ("stylesheet" === n.rel && (r === s || r === e)) return n
						}
						var o = document.getElementsByTagName("style");
						for (l = 0; l < o.length; l++) {
							var n;
							if ((r = (n = o[l]).getAttribute("data-href")) === s || r === e) return n
						}
					}(l, r)) return e();
				! function(s, e, t, l) {
					...
					r.rel = "stylesheet", r.type = "text/css", r.onerror = r.onload = function(o) {
						if (r.onerror = r.onload = null, "load" === o.type) t();
							...
							var n = o && ("load" === o.type ? "missing" : o.type),
								...
								i = new Error("Loading CSS chunk " + s + " failed.\n(" + a + ")");
							i.code = "CSS_CHUNK_LOAD_FAILED", i.type = n, i.request = a, r.parentNode
								.removeChild(r), l(i)
						}
					}, r.href = e, document.head.appendChild(r)
				}(s, r, e, t)
			}))
		}, o = {
			179: 0
		}, i.f.miniCss = function(s, e) {
			o[s] ? e.push(o[s]) : 0 !== o[s] && {
				131: 1,
				269: 1,
				336: 1,
				393: 1,
				...
				9914: 1,
				9996: 1
			} [s] && e.push(o[s] = r(s).then((function() {
				o[s] = 0
			}), (function(e) {
				throw delete o[s], e
			})))
		...
		function() {
				...
				if (0 !== l)
					if (l) t.push(l[2]);
						...
						var o = i.p + i.u(e),
							n = new Error;
						i.l(o, (function(t) {
							if (i.o(s, e) && (0 !== (l = s[e]) && (s[e] = void 0), l)) {
								var r = t && ("load" === t.type ? "missing" : t.type),
									o = t && t.target && t.target.src;
								n.message = "Loading chunk " + e + " failed.\n(" + r + ": " + o + ")", n
									.name = "ChunkLoadError", n.type = r, n.request = o, l[1](n)
							}
						}), "chunk-" + e, e)
					}
			};
			var e = function(e, t) {
					...
					if (o.some((function(e) {
						...
						for (l in n) i.o(n, l) && (i.m[l] = n[l]);
						if (a) a(i)
					}
					for (e && e(t); c < o.length; c++) r = o[c], i.o(s, r) && s[r] && s[r][0](), s[o[c]] = 0
				},
				t = self.webpackChunkCnblogs_Theme_SimpleMemory = self.webpackChunkCnblogs_Theme_SimpleMemory || [];
